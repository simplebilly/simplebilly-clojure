(ns simple-billy-api.specs.order-confirmation-create
...
(def order-confirmation-create-data
  {
...
(def order-confirmation-create-spec
  (ds/spec
    {:name ::order-confirmation-create
     :spec order-confirmation-create-data}))
