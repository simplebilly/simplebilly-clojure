(ns simple-billy-api.specs.shipping-rule-create
...
(def shipping-rule-create-spec
  (ds/spec
    {:name ::shipping-rule-create
     :spec shipping-rule-create-data}))
