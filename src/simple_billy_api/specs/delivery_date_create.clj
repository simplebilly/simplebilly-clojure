(ns simple-billy-api.specs.delivery-date-create
...
(def delivery-date-create-spec
  (ds/spec
    {:name ::delivery-date-create
     :spec delivery-date-create-data}))
